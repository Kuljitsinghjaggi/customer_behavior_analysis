...
-- Note: Using ::numeric is specific to PostgreSQL. 
-- For SQL Server, use CAST(review_rating AS FLOAT).
SELECT 
    item_purchased, 
...
-- Q5. Subscriber vs Non-subscriber spending habits?
SELECT 
    subscription_status,
...
-- Q6. Top 5 products with the highest percentage of discounts applied?
SELECT 
    item_purchased,
...
-- Note: This assumes you already have an 'age_group' column.
SELECT 
    age_group,
